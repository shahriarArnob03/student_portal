            ...
            <c:choose>
              <c:when test="${sessionScope.authorId == user.authorId}">
                <div class="d-grid gap-2 mt-3">
                  <a href="${pageContext.request.contextPath}/submission.jsp"
                     class="btn btn-success">Upload to My Folder</a>
                  <a href="${pageContext.request.contextPath}/viewSubmissions"
                     class="btn btn-outline-primary">View My Submissions</a>
                </div>
              </c:when>
              <c:otherwise>
                <div class="d-grid gap-2 mt-3">
                  <a href="${pageContext.request.contextPath}/viewSubmissions?studentId=${user.authorId}"
                     class="btn btn-outline-primary">View Folder</a>
                </div>
              </c:otherwise>
            </c:choose>
          </div>
